    ...
    public class OrderService
        ...
        public OrderService(List<Goods> g)
        {
            ...
            public List<Order> CheckOrder(int a,string s)//a查找类型，s查找变量值
            {
                switch (a)
                {
                    case 1: var q1 = from order in orders
                    ...
                    case 4: var q4 = from order in orders
            ...
            switch (type)
            {
                case "num":oD1.ItemNums = Int32.Parse(value);
                    ...
                    break;
                case "goods": var g = from go in goods
                                      where go.Name == value
                                      select go;
                    if (g.Count() == 0)
                    {
            ...
            while (choose != 0)
            {
                switch (choose)
                {
                    ...
                    case 3:
                        ...
                        switch (choose3)
                        {
                            case 1:foreach(Order order1 in service.Orders)
                                {
                                    Console.WriteLine(order1.ToString());
                                }break;
                            case 2:Console.WriteLine("请选择查询方式：1.订单号 2.商品名称 3.用户名称 4.金额数");
                            ...
                            case 3:Console.WriteLine("请输入您想删除的订单的订单号或输入0退出");
                                try
                                {
                            ...
                            case 4:Console.WriteLine("请输入您想修改的订单的订单号或输入0退出");
